                    ...
                    signInAnonymously(auth)
                        .then((userCredential) => {
                            ...
                            update(ref(database, 'rfid/users/' + mono), {
                                ...
                                alert("RFID Update Failed: " + error.message);
                            });
                        })
                        .catch((error) => {
                ...
                <div class="col-md-12 col-lg-10">
                    <div class="wrap d-md-flex">
                            ...
                            <div class="text w-100">
                                ...
                                if ($_SESSION['desig'] == "ADMIN") {
                                    ...
                                    <a href="./allow_lab_creation.php" class="btn btn-white btn-outline-white"
                                        style="margin-top:10px;">Make LAB
                                        ADMIN</a>
                        ...
                        <div class="login-wrap p-4 p-lg-5" id="mainsection">
                            ...
                            <div class="form-group mb-3">
                                <label class="label" for="name">RFID</label>
                                <span id="rfidspan" class="err"></span>
                                <span id="rfidspans" class="suc"></span>
                                <input type="number" class="form-control" placeholder="RFID" id="rfid" name="rfid"
                                    maxlength="45" autocomplete="off" onchange="rfva()">
                            </div>
